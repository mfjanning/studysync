          ...
          >
            <div class="flex items-center gap-3 mb-2">
              ...
              <button
                ...
                class="text-slate-300 hover:text-red-500 disabled:opacity-40 transition-colors text-xs font-bold leading-none"
        ...
        <div class="p-5 bg-slate-50 border-t border-slate-100">
          <div v-if="user">
            ...
            <div class="flex justify-between items-center mt-2">
              <div></div>
              <p v-if="neuerKommentar.length > 0" class="text-xs font-medium transition-colors" :class="neuerKommentar.length >= 900 ? 'text-orange-500' : 'text-slate-400'">
